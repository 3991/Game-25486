...
int screen_1::Run(sf::RenderWindow &App){
    ...
    builduingRect.setFillColor(sf::Color(237, 237, 237));//sf::Color(220, 220, 220));
    ...
    sf::FloatRect createBuilduigTextDetection(builduingRect.getPosition().x, builduingRect.getPosition().y, builduingRect.getGlobalBounds().width, builduingRect.getGlobalBounds().height);
