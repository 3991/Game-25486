...
void Creator::setLines(std::vector<sf::Vertex> lines){
    ...
    /*3 pas 2 car transformation des lignes individuelles en ligne connect�es.
    Pour linesStrip reprend auto le dernier point de la derni�re ligne pour commencer la new ligne*/
